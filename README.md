...
- 了解 Git 版本控制基礎
- 熟悉 Claude code與常用skill、MCP Server搭配開發，快速將產品落地
...
| 📚 FE Interview Hub | 前端面試題庫、涵蓋 HTML / CSS / JS / Vue 等常見考題整理 | [code](https://github.com/Xenosword-X/FE-Interview-Hub) | [Demo](https://fe-interview-hub.pages.dev/) |
